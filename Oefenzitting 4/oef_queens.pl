...
/******************************************************************/
/* een versie met freeze die van zodra voor een volgende kolom
een rij-waarde wordt gegenereerd gaat testen of die een koningin 
die links staat kan aanvallen
*/
...
/******************************************************************/
/* je kan ook een versie maken die geen freeze gebruikt maar
ook zo vlug mogelijk test en deze is nog vlugger.....*/
...
verfijn([],_,[]).
verfijn(Kands,Links,[Y|Ys]) :-
	select(Y,Kands,Kands1),
	noattack(Y,Links,1),
	verfijn(Kands1,[Y|Links],Ys).
